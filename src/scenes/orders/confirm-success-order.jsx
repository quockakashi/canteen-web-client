...
import'./confirm-success-order.css'
...
export default function ConfirmSuccessOrder({open, handleClose, title, content, handleContinue}) {
  ...
  return (
    ...
    >
        <Box style={boxStyle(theme)}>
            ...
            The order was created with ID: 23422135
            </Typography>
            <Link 
                className='link'
                to={'/orders/23422135'}>View Details</Link>
